        ...
        >
            ...
            <div style={{ marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div className="setting-card" style={{
                    ...
                    <div>
                        <h3 style={{ margin: 0 }}>REPORT_IDENTITY (COLLEGE)</h3>
                        <p style={{ margin: '5px 0 0 0', opacity: 0.7, fontSize: '0.9rem' }}>
                            College name to display on the PDF report header.
                        </p>
                    </div>
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <input
                            ...
                            style={{
                                ...
                                padding: '10px', width: '250px', fontFamily: 'monospace'
                            }}
                        />
                        <button
                            onClick={() => axios.post(`${import.meta.env.VITE_API_URL}/api/settings`, { key: 'COLLEGE_NAME', value: settings.COLLEGE_NAME })}
                            style={{ padding: '10px 15px', background: '#333', color: '#00ff41', border: '1px solid #555', cursor: 'pointer' }}
                        >
                            UPDATE
                        </button>
                    </div>
                ...
                <div className="setting-card" style={{
                    ...
                    <div>
                        <h3 style={{ margin: 0 }}>REPORT_IDENTITY (DEPT)</h3>
                        <p style={{ margin: '5px 0 0 0', opacity: 0.7, fontSize: '0.9rem' }}>
                            Department name to display on the PDF report header.
                        </p>
                    </div>
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <input
                            type="text"
                            value={settings.DEPT_NAME || ''}
                        ...
                        />
                        <button
                            onClick={() => axios.post(`${import.meta.env.VITE_API_URL}/api/settings`, { key: 'DEPT_NAME', value: settings.DEPT_NAME })}
                            style={{ padding: '10px 15px', background: '#333', color: '#00ff41', border: '1px solid #555', cursor: 'pointer' }}
                        >
                            UPDATE
                        </button>
